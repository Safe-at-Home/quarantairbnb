  ...
  return (
    <>
      ...
      <Route
        path="/login"
        render={(props) => (
          <LoginRegistrationScreen {...props} isLogin={true} />
        )}
      />
      <Route
        path="/registerHost"
        render={(props) => (
          <LoginRegistrationScreen {...props} isLogin={false} isHost={true} />
        )}
      />
      <Route
        path="/registerGuest"
        render={(props) => (
          <LoginRegistrationScreen {...props} isLogin={false} isHost={false} />
        )}
      />
      ...
      <br />
      <Image src="logo-govtech.png" size="small" />
    </>
  );
}
